...
func main() {
	...
	skynetService := bankSkynet.NewService(alertService, chefStore, calloutService)
	skynetService = bankSkynet.NewLoggingService(log.With(logger, "component", "skynet"), skynetService)
	skynetService = bankSkynet.NewInstrumentService(kitprometheus.NewCounterFrom(stdprometheus.CounterOpts{
		Namespace: "api",
		Subsystem: "skynet",
		Name:      "request_count",
		Help:      "Number of requests received.",
